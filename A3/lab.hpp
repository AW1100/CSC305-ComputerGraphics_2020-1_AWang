...
public:
    ...
    void loadDataToGPU(std::array<float, 216> const& vertices)
    {
        ...
        [[maybe_unused]] int height)
    {
        ...
        auto viewMat{ glm::lookAt(glm::vec3{10.0f,5.0f,10.0f},		//camera looking
                                    glm::vec3{0.0f,0.0f,0.0f},		//camera is
